...
@section('title', 'Edit Tahun Produksi Telur Ayam')

@section('pageHeading')
<h1 class="h3 mb-0 text-gray-800">Edit Tahun Produksi Telur Ayam</h1>
@endsection
...
<div class="col-lg-12">
    <div class="card mb-4 py-3 border-left-primary">
        <div class="card-body">
            <form action="{{ route('tahunProduksiAdmin.update', $tahunProduksiAdmin->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="form-group">
                    <label class="font-weight-bold">Tahun Produksi Telur Ayam</label>
                    <input type="text" class="form-control @error('tahunProduksi') is-invalid @enderror" name="tahunProduksi" value="{{ old('tahunProduksi', $tahunProduksiAdmin->tahunProduksi) }}">
                    <!-- error message untuk ntahunProduksi -->
                    @error('tahunProduksi')

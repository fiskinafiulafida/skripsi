...
@section('title', 'Create Data Kandang Ayam')
...
<div class="col-lg-12">
    <div class="card mb-4 py-3 border-left-primary">
        <div class="card-body">
            <form action="{{ route('kandangAdmin.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="form-group">
                    <label class="font-weight-bold">Nama Kandang Ayam</label>
                    <input type="text" class="form-control @error('nama_kandang') is-invalid @enderror" name="nama_kandang" value="{{ old('nama_kandang') }}" placeholder="Masukkan Nama Kandang Ayam">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control @error('keterangan_kandang') is-invalid @enderror" name="keterangan_kandang" id="keterangan_kandang" rows="5" value="{{ old('keterangan_kandang') }}" placeholder="Masukkan Keterangan Kandang Ayam"></textarea>

...
@section('pageHeading')
<h1 class="h3 mb-0 text-gray-800">Edit Profile User</h1>
@endsection
...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route('profilePemilik.update', $profilePemilik->id) }}">
            @csrf
            @method('PUT')
                                ...
                                <div class="card-body p-4">
                                    ...
                                    <div class="row pt-1">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-12">
                                                <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name', $profilePemilik->name) }}" autocomplete="name" autofocus>
                                                @error('name')
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-12">
                                                <input id="email" type="text" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email', $profilePemilik->email) }}" autocomplete="email" autofocus>
                                                @error('email')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
